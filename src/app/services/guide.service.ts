  ...
  private getLocalGuidesByAttraction(
          ...
          if (profilesJson) {
            ...
            matchingProfiles.forEach((profile: any) => {
              profileGuides.push({
                ...
                profileImageUrl: profile.profilePicture || 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=400&fit=crop',
    ...
    //   };
      ...
      if (!fromDate || !timeFrom || !timeTo) {
        return of(profileGuides);
      }
      
      // Filter by availability and booking conflicts asynchronously
      return this.filterGuidesByAvailability(profileGuides, fromDate, timeFrom, timeTo);
  }
